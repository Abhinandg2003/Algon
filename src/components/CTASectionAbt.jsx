...
export default function CTASectionAbt() {
  return (
    <>
      <style>{`
        /* ── Section ─────────────────────────────────────────────── */
        ...
        .cta-btn2:hover .cta-btn-text::after {
          transform: scaleX(1);
        }
        ...
        .cta-btn2:hover .cta-btn-icon svg {
        ...
        .cta-email2:hover { color: rgba(0,0,0,1); }

        @media (max-width: 768px) {
          .cta-section2 { padding: 80px 0vw 80px; height:auto }
          .cta-bottom2  { display: none; flex-direction: column; align-items: flex-start; gap: 28px; }
          .cta-orb-12   { width: 90vw; height: 90vw; right: -20%; bottom: -20%; }
          .cta-orb-22   { width: 60vw; height: 60vw; }
        }
      `}</style>

      <section data-navbar="dark" className="cta-section2">

        {/* Blue gradient orbs */}
        <div className="cta-orb-12" aria-hidden="true" />
        <div className="cta-orb-22" aria-hidden="true" />
        <div className="cta-orb-32" aria-hidden="true" />

        <div className="cta-inner2  ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2  items-center">
            ...
            <div className="cta-inner">
              ...
              {/* Headline */}
              <h2 className="cta-headline2 font-light robotofont">
              ...
              <Link to="/contact" className="cta-btn2 mt-10 rounded-full border border-[#050508] px-8 py-3 hover:bg-[#050508] hover:text-[#fcfcf7] transition-all duration-300">
                <span className="cta-btn-text2">Start a project</span>
